...
export default function Map({ navigation }) {
  ...
  const data = [
    ...
    // 30.131539196258302, 31.133090451680452
    {
      latitude: 30.131539196258302,
      longitude: 31.133090451680452,
      name: "عيادة دكتورة ايناس السيسي لطب الاطفال",
    },
    // 30.03979652408999, 31.01656597664994
    {
      latitude: 30.03979652408999,
      longitude: 31.01656597664994,
      name: "عيادة أطفال ا.د.هنداوي",
    },
    // 30.040668977787277, 31.004200597270366
    {
      latitude: 30.040668977787277,
      longitude: 31.004200597270366,
      name: "عيادة أطفالنا",
    },
    // 30.051231814738898, 31.39493917585419
    {
      latitude: 30.051231814738898,
      longitude: 31.39493917585419,
      name: "مركز طفلي لطب الاطفال ",
    },
  ];
